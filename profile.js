...
//         html: `
//            <input type="text" id="userName" class="swal2-input" placeholder="Enter your name">
//       <button id="uploadPic" class="swal2-confirm swal2-styled" style="margin: 10px auto; background-color: #3085d6;">
//         Upload Profile Picture
//       </button>
//       <img id="uploadedPicPreview" style="display: none; margin-top: 10px; max-width: 100px; border: 1px solid #ccc;"`,
//       showCancelButton: true,
//         confirmButtonText: 'Update', didRender: () => {
//           // When the SweetAlert is rendered, add event listener to the upload button
//           const uploadButton = document.getElementById("uploadPic");
//           const previewImage = document.getElementById("uploadedPicPreview");
...
//                 sources: ["local", "camera"], // Allow uploads from device or camera
//                 multiple: false, // Single file upload
//               },
//               (error, result) => {
//                 if (!error && result.event === "success") {
//                   const uploadedPicURL = result.info.secure_url; // Get the uploaded image URL
//                   previewImage.src = uploadedPicURL;
//                   previewImage.style.display = "block"; // Show the uploaded image preview
//                   previewImage.dataset.picUrl = uploadedPicURL; // Store the URL for later use
//                 } else if (error) {
...
//         preConfirm: () => {
//           const userName = document.getElementById('userName').value;
//           const userPic = document.getElementById("uploadedPicPreview").dataset.picUrl;
//          //validate inputs
//           if (!userName || !userPic) {
//             Swal.showValidationMessage('Both name and picture URL are required');
//             return false;
